...
public class UserSignDemo extends  SpringBootDemoCacheRedisApplicationTests {

    private Jedis jedis = new Jedis("114.67.105.74",6348);
    ...
    public boolean doSign(int uid, LocalDate date) {
        ...
        redisTemplate.opsForValue().setBit(buildSignKey(uid, date), offset, true);
